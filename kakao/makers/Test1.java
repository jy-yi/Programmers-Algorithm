 ...
 * 
 * 예를 들어 상품권을 가진 사람이 5명이고, 
 * 첫 번째 사람부터 가지고 있는 상품권에 적힌 번호가 [4, 5, 3, 2, 1], 각 사람이 받고 싶어 하는 상품 번호가 순서대로 [2, 4, 4, 5, 1]라고 하겠습니다.
 * 
 ...
 * 
 * [2, 4, 3, 5, 1]
 * 세 번째 사람은 4번 상품을 받고 싶지만, 더 교환할 사람이 없습니다. 
 * 따라서 원하는 상품을 받을 수 없는 사람은 최소 1명이 됩니다.
 * 
...
public class Test1 {
	...
	public static int solution(int[] gift_cards, int[] wants) {
        ...
        /* 정렬된 배열이므로 앞에서부터 일치하는 카드 하나씩 소거 */
